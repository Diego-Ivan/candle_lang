...
mod tests {
    ...
    fn test_simple_command() {
        ...
        assert!(matches!(tokens[0].as_ref().unwrap().get_type(), TokenType::Load));
        assert!(matches!(tokens[1].as_ref().unwrap().get_type(), TokenType::Id(_)));
        assert!(matches!(tokens[2].as_ref().unwrap().get_type(), TokenType::Semicolon));
    }
    ...
    fn test_complex_statement() {
        ...
        assert!(matches!(tokens[0].as_ref().unwrap().get_type(), TokenType::Init));
        assert!(matches!(tokens[1].as_ref().unwrap().get_type(), TokenType::Id(_)));
        assert!(matches!(tokens[2].as_ref().unwrap().get_type(), TokenType::Colon));
        assert!(matches!(tokens[3].as_ref().unwrap().get_type(), TokenType::LeftBrace));
    }
    ...
    fn test_mixed_tokens() {
        ...
        assert!(matches!(tokens[0].as_ref().unwrap().get_type(), TokenType::Select));
        assert!(matches!(tokens[1].as_ref().unwrap().get_type(), TokenType::Id(_)));
        assert!(matches!(tokens[2].as_ref().unwrap().get_type(), TokenType::From));
        assert!(matches!(tokens[3].as_ref().unwrap().get_type(), TokenType::String(_)));
        assert!(matches!(tokens[4].as_ref().unwrap().get_type(), TokenType::Semicolon));
    }
    ...
    fn test_number_followed_by_identifier() {
        ...
        assert!(matches!(tokens[0].as_ref().unwrap().get_type(), TokenType::Number(_)));
        assert!(matches!(tokens[1].as_ref().unwrap().get_type(), TokenType::Id(_)));
    }
    ...
    fn test_decimal_without_trailing_digits() {
        ...
        assert_eq!(tokens.len(), 3);
        assert!(matches!(tokens[0].as_ref().unwrap().get_type(), TokenType::Number(123.0)));
